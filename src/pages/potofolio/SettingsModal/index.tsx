...
function SettingsModal(props: any, ref) {
  ...
  return (
    <Modal
      visible={visible}
      className={
        loginStep === 1 ? styles.modal : loginStep === 2 ? styles.modalTwo : ''
      }
      closable={false}
      footer={null}
    >
      <div>
        <div
          style={{ textAlign: 'right', marginRight: '16px', marginTop: '16px' }}
          onClick={() => close()}
        >
          <svg
            width="18"
...
export default forwardRef<DetailDrawerRef, any>(SettingsModal);
